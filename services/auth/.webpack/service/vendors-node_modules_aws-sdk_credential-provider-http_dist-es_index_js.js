 ...
 */
exports.id = "vendors-node_modules_aws-sdk_credential-provider-http_dist-es_index_js";
exports.ids = ["vendors-node_modules_aws-sdk_credential-provider-http_dist-es_index_js"];
exports.modules = {
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   retryWrapper: () => (/* binding */ retryWrapper)\n/* harmony export */ });\nconst retryWrapper = (toRetry, maxRetries, delayMs) => {\n    return async () => {\n        for (let i = 0; i < maxRetries; ++i) {\n            try {\n                return await toRetry();\n            }\n            catch (e) {\n                await new Promise((resolve) => setTimeout(resolve, delayMs));\n            }\n        }\n        return await toRetry();\n    };\n};\n\n\n//# sourceURL=webpack://@namecard/auth-service/../../node_modules/@aws-sdk/credential-provider-http/dist-es/fromHttp/retry-wrapper.js?\n}");
