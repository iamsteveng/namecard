...
export default function CardDetails({ 
  ...
  const primaryCompany = card.companies?.[0]?.hasOwnProperty('company') ? 
  ...
  // Get enriched data
  let enrichmentData = card.enrichmentData;
  
  // DEMO: Add sample enrichment data for SINO GROUP to demonstrate functionality
  if (!enrichmentData && card.company === 'SINO GROUP') {
    enrichmentData = {
      personData: {
        name: card.name,
        title: card.title,
        currentRole: 'Group Associate Director',
        experience: [
          {
            company: 'SINO GROUP',
            role: 'Group Associate Director',
            duration: '2020 - Present',
            description: 'Leading strategic initiatives and business development across the group portfolio.'
          },
          {
            company: 'SINO GROUP',
            role: 'Senior Manager',
            duration: '2017 - 2020',
            description: 'Managed key client relationships and project delivery for major developments.'
          }
        ],
        education: [
          {
            ...
            field: 'Real Estate and Construction Management',
            year: 2016
          }
        ],
        expertise: ['Real Estate Development', 'Property Management', 'Strategic Planning', 'Business Development'],
        skills: ['Project Management', 'Stakeholder Relations', 'Financial Analysis', 'Market Research'],
        linkedinUrl: 'https://www.linkedin.com/in/davidng-sino',
        confidence: 0.85,
      ...
      companyData: {
        name: 'SINO GROUP',
        domain: 'sino.com',
        website: 'https://sino.com',
        description: 'One of Hong Kong\'s leading property development companies with a diversified portfolio including residential, commercial, and hospitality properties.',
        industry: 'Real Estate Development',
        headquarters: 'Hong Kong',
        employeeCount: 2500,
        founded: 1971,
        annualRevenue: '$2.5B - $5B',
        recentNews: [
          {
            title: 'SINO GROUP Announces New Sustainable Development Initiative',
            summary: 'The company unveiled plans for carbon-neutral buildings and green construction practices across all new projects.',
            url: 'https://news.sino.com/sustainability-2025',
            publishDate: '2025-08-05',
            source: 'SINO Group Press Release'
          },
          {
            title: 'Record Sales Performance in Luxury Residential Segment',
            summary: 'SINO GROUP reported exceptional sales growth in the luxury residential market, driven by premium developments in prime locations.',
            url: 'https://news.sino.com/sales-results-q2-2025',
            publishDate: '2025-07-28',
            source: 'Hong Kong Business Journal'
          }
        ],
        keyPeople: [
          {
            name: 'Daryl Ng',
            role: 'Chairman',
            description: 'Leading the company\'s strategic vision and expansion into new markets.'
          },
          {
            name: 'Robert Ng',
            role: 'Deputy Chairman',
            description: 'Overseeing operations and development projects across the portfolio.'
          }
        ],
        competitors: ['Sun Hung Kai Properties', 'CK Asset Holdings', 'New World Development'],
        marketPosition: 'Leading property developer in Hong Kong with strong market presence in luxury residential and commercial segments.',
        businessModel: 'Integrated property development focusing on prime locations with emphasis on luxury residential, commercial, and hospitality projects.',
        recentDevelopments: [
          'Launched new luxury residential project in Central District',
          'Acquired prime development site in Tsim Sha Tsui',
          'Completed renovation of flagship commercial property'
        ],
        confidence: 0.92,
        lastUpdated: new Date('2025-08-07')
      },
      citations: [
        {
          url: 'https://sino.com/about',
          title: 'SINO GROUP - Company Overview',
          source: 'Official Website',
          accessDate: '2025-08-07',
          relevance: 0.95,
          category: 'company' as const
        },
        {
          url: 'https://linkedin.com/company/sino-group',
          title: 'SINO GROUP - LinkedIn Company Page',
          source: 'LinkedIn',
          accessDate: '2025-08-07',
          relevance: 0.88,
          category: 'company' as const
        ...
        {
          url: 'https://bloomberg.com/sino-group-profile',
          title: 'SINO GROUP Market Analysis',
          source: 'Bloomberg',
          accessDate: '2025-08-07',
          relevance: 0.92,
      ...
      researchQuery: `David W. L. Ng Group Associate Director SINO GROUP professional profile company information`,
      researchDate: new Date('2025-08-07'),
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
          <div className="p-6">
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {personData.education.map((edu, index) => (
                      <div key={index} className="border-l-2 border-green-100 pl-4 py-2">
                        ...
                        {edu.degree && (
                          <div className="text-green-600">{edu.degree}</div>
                        )}
                        {edu.field && (
                          ...
                          {personData.awards.map((award, index) => (
                            <div key={index} className="flex items-center justify-between p-2 bg-yellow-50 rounded-lg border border-yellow-200">
                              <div>
                                ...
                                {award.organization && (
                                  <span className="text-sm text-gray-600 ml-2">- {award.organization}</span>
                                )}
                              </div>
                              {award.year && (
              ...
              {(personData.publications || personData.speakingEngagements) && (
                <div>
                  ...
                  <div className="space-y-4">
                          ...
                          {personData.publications.map((pub, index) => (
                            <div key={index} className="border-l-2 border-indigo-100 pl-4 py-2">
                              ...
                              <div className="flex items-center gap-4 mt-1">
                                {pub.publishDate && (
                                  <span className="text-sm text-gray-500">{formatDate(pub.publishDate)}</span>
                                )}
                                {pub.url && (
                                  <a
                                    href={pub.url}
                    ...
                    {personData.speakingEngagements && personData.speakingEngagements.length > 0 && (
                      <div>
                        ...
                        <div className="space-y-3">
                          {personData.speakingEngagements.map((speaking, index) => (
                            <div key={index} className="border-l-2 border-orange-100 pl-4 py-2">
                              ...
                              <div className="flex items-center gap-4 mt-1">
                                {speaking.date && (
                                  <span className="text-sm text-gray-500">{formatDate(speaking.date)}</span>
                                )}
                                {speaking.url && (
                                  <a
                                    href={speaking.url}
              ...
              {(personData.boardMemberships || personData.advisoryRoles || personData.professionalMemberships) && (
                <div>
                  <h3 className="font-medium text-gray-900 mb-3 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {personData.professionalMemberships && personData.professionalMemberships.length > 0 && (
                      <div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    {personData.industryInfluence && (
                      <div>
                        <h4 className="text-sm font-medium text-gray-700 mb-2">Industry Influence</h4>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
          <div className="p-6">
            ...
            <div className="space-y-6">
              ...
              {/* Market Analysis */}
              {(companyData?.competitors || companyData?.marketPosition || companyData?.businessModel) && (
                <div>
                  <h3 className="font-medium text-gray-900 mb-3 flex items-center gap-2">
                    <Target className="h-4 w-4" />
                    Market Analysis
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <span className={clsx(
                          ...
                          citation.category === 'person' ? 'bg-blue-100 text-blue-700' :
                          citation.category === 'company' ? 'bg-green-100 text-green-700' :
                ...
                <div className="flex items-center justify-between mt-3 text-xs text-gray-500">
                  ...
                  <div className="flex items-center gap-4">
                    {enrichmentData.personConfidence && (
                      <span>Person Confidence: {Math.round(enrichmentData.personConfidence * 100)}%</span>
                    )}
                    {enrichmentData.companyConfidence && (
                      <span>Company Confidence: {Math.round(enrichmentData.companyConfidence * 100)}%</span>
                    )}
                    ...
                    <div>
                      ...
                      {enrichment.companiesFound > 0 && (
                        <p className="text-sm text-gray-600">
                          {enrichment.companiesFound} companies found, {enrichment.dataPointsAdded} data points added
                        </p>
                      )}
                    </div>
                  </div>
